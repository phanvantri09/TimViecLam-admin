                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Danh sách các rank</h3>
                            
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="card-header">
                                <button class="btn btn-primary"><a style="color: white" href="{{route('Rank.Add')}}">Thêm mới</a></button>
                            </div>
                                    ...
                                    @foreach ($rank as $rak)
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <a class="btn btn-app" href="{{route('Rank.Edit',['id' => $rak->id])}}">
                                                    <i class="fas fa-edit"></i> Sửa
                                                </a>
                                                <a class="btn btn-app"
                                                    onclick=" return confirm('Bạn có chắc chắn muốn xóa không')"
                                                    href="{{route('Rank.Delete',['id'=> $rak->id])}}">
