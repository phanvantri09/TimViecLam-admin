                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Danh sách các từ khóa bị cấm</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h3>Thêm từ khóa bị cấm</h3>
                                        <form action="{{ route('SensitiveKeyword.addKeywordSensitive') }}" method="POST">
                                            @csrf
                                            <div class="form-group">
                                                <label for="name">Tên từ khóa:</label>
                                                <input type="text" name="name" class="form-control" id="name" placeholder="Nhập tên từ khóa">
                                            </div>
                                            ...
                                            <tbody>
                                                @foreach ($key as $key)
                                                    ...
                                                    <td class="dtr-control sorting_1" tabindex="0">
                                                        ...
                                                        <td>
                                                            <form action="{{ route('SensitiveKeyword.deleteKeyword',['id' => $key->id]) }}" method="GET">
                                                                @csrf
                                                                <button type="submit" class="btn btn-app"><i class="fas fa-edit"></i> Xóa</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                @endforeach
